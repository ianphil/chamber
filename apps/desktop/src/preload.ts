...
const electronAPI: ElectronAPI = {
  ...
  voice: {
    ...
    startSession: (modelId) => ipcRenderer.invoke(IPC.VOICE.START_SESSION, modelId),
    appendAudio: (pcm) => ipcRenderer.invoke(IPC.VOICE.APPEND_AUDIO, pcm),
    endSession: () => ipcRenderer.invoke(IPC.VOICE.END_SESSION),
